...
export const CHECK_WIRE_REPORT_TOKEN = 'CHECK_WIRE_REPORT_TOKEN';

export const DELIVEROO_VERIFY = 'DELIVEROO_VERIFY';
export const DELIVEROO_RESET = 'DELIVEROO_RESET';

export const GET_VIP_PRODUCTS = 'GET_VIP_PRODUCTS';
